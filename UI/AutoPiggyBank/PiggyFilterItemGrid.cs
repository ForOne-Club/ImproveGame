...
public class PiggyFilterItemGrid : ScrollView
{
    public static List<Item> Items => AutoMoneyPlayerListener.AllCurrencies;

    public PiggyFilterItemGrid()
    {
    ...
    public void ResetBottomGrid()
    {
        ...
        {
            var itemSlot = new PiggyFilterItemSlot(Items, i)
            {
