...
{
    private static string LeftClickDisable => GetText("BuffTracker.LeftClickDisable");
    private static string LeftClickEnable => GetText("BuffTracker.LeftClickEnable");
    public static string GetLeftClickString(bool enable)
    {
        return enable ? LeftClickDisable : LeftClickEnable;
    }

    private static string RightClickDisable => GetText("BuffTracker.RightClickDisable");
    private static string RightClickEnable => GetText("BuffTracker.RightClickEnable");
