...
public static class ItemHelper
{
    ...
    public static void SetUseValues(this Item item, int useStyle, SoundStyle soundStyle, int useAnimation, int useTime, bool autoReuse = false, bool useTurn = false, bool noUseGraphic = false, bool channel = false, int mana = 0)
    {
