...
- NPC快捷回家功能有时失效
- 稻草人被算入图鉴
- **[v1.7.0.1]** 总控在不使用 ~ 作为快捷键时无法使用
- **[v1.7.0.2]** 自动重召唤功能可能使游戏出错
- **[v1.7.0.2]** 物品框可能出现渲染问题
- **[v1.7.0.2]** 在“城镇NPC刷新速度乘数”设为1x的情况下，“更好的城镇NPC入住机制”无效果
- **[v1.7.0.2]** 在游戏控制台输出垃圾信息
