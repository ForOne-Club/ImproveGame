...
public class LocDebugTemporaryFix : ModSystem
{
    ...
    {
        if (LocalizationDebuggingKeybind == null || !PlayerInput.Triggers.JustPressed.KeyStatus.ContainsKey(LocalizationDebuggingKeybind.FullName) || !LocalizationDebuggingKeybind.JustPressed)
            return;
